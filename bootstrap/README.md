...
| <a name="input_budget_channels"></a> [budget\_channels](#input\_budget\_channels) | Budget notification channels | `map(string)` | <pre>{<br/>  "michal-kopec": "michalkopec11111@gmail.com",<br/>  "wiktor-pytlewski": "wiktorpytlewski@gmail.com"<br/>}</pre> | no |
